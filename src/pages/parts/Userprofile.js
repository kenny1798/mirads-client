                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="card-block">
                                                                ...
                                                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600 mt-5">Marketing Info</h6>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <p class="mb-1 f-w-600 mt-3">Contacts</p>
                                                                        <h6 class="text-muted f-w-400">{userObject.contacts} leads</h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="mb-1 f-w-600 mt-3">Copywriting</p>
                                                                        <h6 class="text-muted f-w-400">{userObject.allowedGenerateCW} left</h6>
                                                                    </div>
                                                                </div>
