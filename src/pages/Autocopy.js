...
<div className='App'>
    <div className="container mt-3">
      <div className="row justify-content-center text-center">
        ...
        <h1 className="mt-4 header-title">AUTO COPIES</h1>
        <p className='header-desc'> Generate copywritings anytime, anywhere with these <span className='higlight-desc'>EZ Step-By-Step</span> Generator</p>
        <p className='text-danger'><strong>WARNING! :</strong> Generated copywritings will not be stored in our database</p>
        </div>
        </div>
